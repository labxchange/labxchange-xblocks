...
"""
labxchange-xblocks documentation build configuration file.
...
project = 'labxchange-xblocks'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'LabXchange XBlocks'
...
#
# html_title = 'labxchange-xblocks v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'XBlocks for Labxchange.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'labxchange_xblocks'),
                os.path.join(root_path, 'labxchange_xblocks/migrations')])
